...
import { inject, input, effect, Directive, Component, DOCUMENT, Renderer2, computed, signal, output, resource, HostListener, ViewEncapsulation, ApplicationRef, EnvironmentInjector, createComponent, inputBinding, Injectable, Optional, Self, ElementRef, NgZone, ViewContainerRef, model, provideZonelessChangeDetection } from '@angular/core';
...
class BaseComponent {
    ...
    language = input(DEFAULT_LANG, ...(ngDevMode ? [{ debugName: "language", transform: (value) => (value ?? DEFAULT_LANG).toLocaleLowerCase() }] : [{ transform: (value) => (value ?? DEFAULT_LANG).toLocaleLowerCase() }]));
    static selector;
    constructor() {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: BaseComponent, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "20.3.16", type: BaseComponent, isStandalone: true, inputs: { language: { classPropertyName: "language", publicName: "language", isSignal: true, isRequired: false, transformFunction: null } }, ngImport: i0 });
}
...
class SpinnerIcon {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: SpinnerIcon, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.16", type: SpinnerIcon, isStandalone: true, selector: "spinner-icon", ngImport: i0, template: `
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: SpinnerIcon, decorators: [{
            type: Component,
...
class FacebookLogin extends BaseComponent {
    ...
    COMPUTED_API_KEY = computed(() => this.API_KEY() ?? this.PROVIDED_API_KEY(), ...(ngDevMode ? [{ debugName: "COMPUTED_API_KEY" }] : []));
    facebookSDKInjected = signal(false, ...(ngDevMode ? [{ debugName: "facebookSDKInjected" }] : []));
    onSuccess = output({ alias: 'success' });
    onError = output({ alias: 'error' });
    APP_ID = input.required(...(ngDevMode ? [{ debugName: "APP_ID" }] : []));
    CONFIG_ID = input.required(...(ngDevMode ? [{ debugName: "CONFIG_ID" }] : []));
    URL = input("https://richarddev.vierkant.dev", ...(ngDevMode ? [{ debugName: "URL" }] : []));
    PROVIDED_API_KEY = input(undefined, ...(ngDevMode ? [{ debugName: "PROVIDED_API_KEY", alias: 'API_KEY' }] : [{ alias: 'API_KEY' }]));
    API_KEY = signal(undefined, ...(ngDevMode ? [{ debugName: "API_KEY" }] : []));
    hasAPIKey = computed(() => !!this.COMPUTED_API_KEY(), ...(ngDevMode ? [{ debugName: "hasAPIKey" }] : []));
    facebookButtonDisabled = signal(true, ...(ngDevMode ? [{ debugName: "facebookButtonDisabled" }] : []));
    facebookState = signal("loading", ...(ngDevMode ? [{ debugName: "facebookState" }] : []));
    facebookResponse = signal(null, ...(ngDevMode ? [{ debugName: "facebookResponse" }] : []));
    facebookLoginAuthCode = signal(undefined, ...(ngDevMode ? [{ debugName: "facebookLoginAuthCode" }] : []));
    // TODO: Load state for button
    facebookLoginToken = resource({
...
class ClearIcon {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: ClearIcon, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.16", type: ClearIcon, isStandalone: true, selector: "clear-icon", ngImport: i0, template: `
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: ClearIcon, decorators: [{
            type: Component,
...
class EditIcon {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: EditIcon, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.16", type: EditIcon, isStandalone: true, selector: "edit-icon", ngImport: i0, template: `
<svg class="icon" xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 640"><!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc.-->
            <path
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: EditIcon, decorators: [{
            type: Component,
...
class TemplateList extends BaseComponent {
    ...
    data = input([], ...(ngDevMode ? [{ debugName: "data", transform: (value) => sortBy(value, t => t.name, t => t.language, t => t.category, t => t.status) }] : [{
            transform: (value) => sortBy(value, t => t.name, t => t.language, t => t.category, t => t.status)
        }]));
...
class Confirmation extends BaseComponent {
    ...
    confirmText = input("TEMPLATE_EDITOR.BUTTONS.CANCEL", ...(ngDevMode ? [{ debugName: "confirmText" }] : []));
    cancelText = input("TEMPLATE_EDITOR.BUTTONS.CONFIRM", ...(ngDevMode ? [{ debugName: "cancelText" }] : []));
...
class ConfirmationService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: ConfirmationService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: ConfirmationService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: ConfirmationService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
class MaxLengthDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: MaxLengthDirective, deps: [{ token: i0.ElementRef }, { token: i0.Renderer2 }, { token: i2.NgControl, optional: true, self: true }], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "20.3.16", type: MaxLengthDirective, isStandalone: true, selector: "[maxlength]", ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: MaxLengthDirective, decorators: [{
            type: Directive,
            args: [{
                    selector: '[maxlength]'
                }]
...
class TooltipDirective {
    tooltipText = input.required(...(ngDevMode ? [{ debugName: "tooltipText", alias: 'tooltip' }] : [{ alias: 'tooltip' }]));
    isTooltipDisabled = input(false, ...(ngDevMode ? [{ debugName: "isTooltipDisabled", alias: 'tooltipDisabled' }] : [{ alias: 'tooltipDisabled' }]));
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: TooltipDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "20.3.16", type: TooltipDirective, isStandalone: true, selector: "[tooltip]", inputs: { tooltipText: { classPropertyName: "tooltipText", publicName: "tooltip", isSignal: true, isRequired: true, transformFunction: null }, isTooltipDisabled: { classPropertyName: "isTooltipDisabled", publicName: "tooltipDisabled", isSignal: true, isRequired: false, transformFunction: null } }, host: { listeners: { "keyup.esc": "onEscape()" } }, ngImport: i0 });
}
...
class DeleteIcon {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: DeleteIcon, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.16", type: DeleteIcon, isStandalone: true, selector: "delete-icon", ngImport: i0, template: `
<svg xmlns="http://www.w3.org/2000/svg"
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: DeleteIcon, decorators: [{
            type: Component,
...
class HeaderPart {
    ...
    }, ...(ngDevMode ? [{ debugName: "qualitySeverity" }] : []));
    ...
    }, ...(ngDevMode ? [{ debugName: "statusSeverity" }] : []));
    category = computed(() => {
...
class PlaceholderInsertComponent {
    targetInput = input.required(...(ngDevMode ? [{ debugName: "targetInput" }] : []));
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: PlaceholderInsertComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "20.3.16", type: PlaceholderInsertComponent, isStandalone: true, selector: "placeholder-insert", inputs: { targetInput: { classPropertyName: "targetInput", publicName: "targetInput", isSignal: true, isRequired: true, transformFunction: null }, options: { classPropertyName: "options", publicName: "options", isSignal: true, isRequired: true, transformFunction: null } }, ngImport: i0, template: `
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: PlaceholderInsertComponent, decorators: [{
            type: Component,
...
class PlaceholderInsertPopover {
    ...
    placeholderOptions = input.required(...(ngDevMode ? [{ debugName: "placeholderOptions", alias: 'placeholderInsert' }] : [{ alias: 'placeholderInsert' }]));
    constructor() {
        effect(() => {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: PlaceholderInsertPopover, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "20.3.16", type: PlaceholderInsertPopover, isStandalone: true, selector: "[placeholderInsert]", inputs: { placeholderOptions: { classPropertyName: "placeholderOptions", publicName: "placeholderInsert", isSignal: true, isRequired: true, transformFunction: null } }, host: { listeners: { "keyup.esc": "onEscape()" } }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: PlaceholderInsertPopover, decorators: [{
            type: Directive,
            args: [{
...
class TemplateEditor extends BaseComponent {
    ...
    data = model(structuredClone(DEFAULT_DATA), ...(ngDevMode ? [{ debugName: "data" }] : []));
    options = input(DEFAULT_OPTIONS, ...(ngDevMode ? [{ debugName: "options", transform: (val) => sortBy(val, x => x.label.toLowerCase()) }] : [{ transform: (val) => sortBy(val, x => x.label.toLowerCase()) }]));
    onSave = output({ alias: 'save' });
